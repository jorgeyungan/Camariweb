...
public class crudDfacpro {
    public boolean save(clsDfacpro dfacpro)
    {
        boolean r = false;
    ...
    public boolean delete(clsDfacpro dfacpro)
    {
        boolean r = false;
    ...
    public boolean update(clsDfacpro dfacpro)
    {
        boolean r = false;
    ...
    public ArrayList<clsDfacpro> findbyAll() {
