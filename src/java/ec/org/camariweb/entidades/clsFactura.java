...
public class clsFactura {
    ...
    public clsFactura(int _no, clsCliente _idcliente, Date _fecha, Double _subtotal, Double _iva, Double _total) {
        this._no = _no;
    ...
    public String toString() {
        return "clsFactura{" + "_no=" + _no + ", _idcliente=" + _idcliente + ", _fecha=" + _fecha + ", _subtotal=" + _subtotal + ", _iva=" + _iva + ", _total=" + _total + '}';
    }
